...
class Dados{
    ...
    public:
        ...
        void lanzamiento(); //Función que simula el lanszamiento de dos dados
        ...
        friend std::ostream &operator<<(std::ostream &os, const Dados &d);
        friend std::istream &operator>>(std::istream &is, Dados &d);
};
